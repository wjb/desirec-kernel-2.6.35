...
#ifdef CONFIG_TOUCHSCREEN_MELFAS_I2C
...
static void desirec_usb_phy_shutdown(void)
{
	printk("desirec_usb_phy_shutdown\n");
	gpio_set_value(DESIREC_GPIO_USB_PHY_RST_N, 0);
}
...
static void __init desirec_init(void)
{
	...
	msm_add_usb_devices(desirec_usb_phy_reset, desirec_usb_phy_shutdown);
